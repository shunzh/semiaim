...
is $\langle {\sf Intent}, {\sf Type}, {\sf Entry}, {\sf AccProf} \rangle$,
where
...
${\sf AccProf} = ( \langle (t_1, 0) \rangle )$
is the acceleration profile list.
Since the acceleration in ${\sf AccProf}$
...
${\sf Entry} = ({\sf Intent}, [t_1,\ t_2], [v_1,\ v_2])$
is the entry statement; and
${\sf AccProf}$ is the acceleration profile list.

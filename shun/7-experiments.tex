...
(semi-)autonomous vehicles to human-driven vehicles while
...
% , and the average delay is the same as Type H's.  When the ratio is
% 1, the traffic has 100\% SA-ACC vehicles and 0\% human-driven
% vehicles, and the average delay is 22.4s.

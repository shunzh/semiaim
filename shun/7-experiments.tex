...
\commentn{TODO I moved this to future work.}
...
The setup of this experiment is same as Figure~\ref{figure2}, but we
...
\commentn{I basicially rewrote this part. Your inline comments were
erased. You questioned why we use different legends for two figures. I
also changed the order of Figure~\ref{fig:figure1} and
Figure~\ref{fig:figure2}. The first one is a very obvious comparison,
and the second one is comparing different features that
semi-autonomous vehicles could have. }
